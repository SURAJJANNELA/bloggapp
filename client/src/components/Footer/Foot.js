        ...
        <div className="row">
          ...
          <div className="col-lg-2">
            <div className="">
              ...
              <ul className="list-unstyled footer-link mt-4">
                <li>
                <NavLink className="nav-link lnk" aria-current="page" to="Signup">Register</NavLink>
                </li>
                <li>
                <NavLink className="nav-link lnk" aria-current="page" to="Signin">Login</NavLink>
                </li>
                <li>
          ...
          <div className="col-lg-4">
            <div className="">
              ...
              <p className="contact-info">+91 7989349436</p>
            </div>
          </div>
        </div>
      </div>
